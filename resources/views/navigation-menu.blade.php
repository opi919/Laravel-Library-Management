<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('publishers.index') }}" :active="request()->routeIs('publishers.index')">
                        {{ __('Publishers') }}
                    </x-jet-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        <x-jet-dropdown>
                            ...
                            <x-slot name="content">
                                ...
                                <div class="py-2">
                                    <x-jet-dropdown-link href="{{ route('user-requests.approved') }}">
                                        {{ __('Approved Requests') }}
                                    </x-jet-dropdown-link>
                                </div>
                                <div class="py-2">
                                    <x-jet-dropdown-link href="{{ route('user-requests.rejected') }}">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('publishers.index') }}" :active="request()->routeIs('publishers.index')">
                {{ __('Publishers') }}
            </x-jet-responsive-nav-link>
        </div>
        <div class="pt-2 pb-3 space-y-1">
